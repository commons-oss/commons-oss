...
import { check, date, integer, pgEnum, pgTable, text, unique, uuid } from "drizzle-orm/pg-core";
...
export const teamMembershipKind = pgEnum("team_membership_kind", ["player", "staff"]);
