...
import { boolean, check, jsonb, pgEnum, pgTable, text, unique, uuid } from "drizzle-orm/pg-core";
...
export const role = pgTable(
  ...
  (t) => [
    ...
    check("role_system_implies_null_org", sql`(${t.isSystem} = false) OR (${t.orgId} IS NULL)`),
