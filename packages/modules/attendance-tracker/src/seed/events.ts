...
const SPECS: EventSpec[] = [
  ...
  },
  {
    ...
    minute: 0,
    durationMinutes: 90,
    title: "Reserve @ ATSV Musterhausen",
    location: "Auswärts",
  },
  {
    team: "Reserve",
...
async function main(): Promise<void> {
  ...
  try {
    const orgRow = await db.select({ id: org.id }).from(org).where(eq(org.slug, "fc-musterstadt"));
